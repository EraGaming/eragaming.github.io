...
(function ($, window, undefined) {
  ...
  $.DLMenu.defaults = {
    ...
    backLabel:
      '<svg role="img" class="df-icon df-icon--left-arrow"><use xlink:href="/assets/img/necromancers.svg#left-arrow"></use></svg> Back',
  ...
  $.fn.jPinning = function (options) {
    ...
    var methods = {
      isUnpinned: function () {
         ...
         * @return boolean
         */
        if (elements.status == 'unpinned') return true;
        return false;
      },
      ...
      isPinned: function () {
         ...
         * @return boolean
         */
        if (elements.status == 'pinned') return true;
        return false;
      },
      ...
      pin: function () {
        ...
        if (methods.isUnpinned()) {
          ...
          elements.target
            .removeClass(classes.unpinned)
            .addClass(classes.pinned);
...
// Re-factored this into embedVideos in custom.js
// (function ($, window, document) {
...
//       // would it be bad to just call my function
